...
hero:
  name: "Ekklesia CMS"
  text: "Built for the African Church"
  tagline: "An open-source, headless, multilingual content management system purpose-built for churches and religious organizations in Francophone Africa and the diaspora."
  actions:
    - theme: brand
      text: Get Started
...
::: tip Ready to explore the architecture?
Start with the [Architecture Overview](/architecture/overview) to understand how the system is designed, or jump straight to the [Core Decisions](/architecture/decisions) to see the reasoning behind the key technical choices.
:::
